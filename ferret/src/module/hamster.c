...
static FILE *fp;
static char filename[256] = "hamster.txt";

void hamster_set_filename(const char *in_filename)
{
	snprintf(filename, sizeof(filename), "%s", in_filename);
}
...
extern unsigned global_packet_count;
